    ...
    MVM:AddSlider({
        ...
        Callback = function(v)
            if game:GetService("Players").LocalPlayer.Character ~= nil and game:GetService("Players").LocalPlayer.Character.Humanoid ~= nil then
                game:GetService("Wokspace"):WaitForChild(game:GetService("Players").LocalPlayer.Name).Humanoid.WalkSpeed = v
            end
        end    
    })
    MVM:AddSlider({
...
elseif game.PlaceId == 1962086868 or 5253186791 or 3582763398 then

    print("TOH | Tower Of Hell")
    local TOH = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
    local Window = nil
    if game.PlaceId == 1962086868 then
        Window = TOH:MakeWindow({Name = "Helix Hub | TOWER OF HELL", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest"})
    elseif game.PlaceId == 3582763398 then
        Window = TOH:MakeWindow({Name = "Helix Hub | PRO TOWER OF HELL", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest"})
    elseif game.PlaceId == 5253186791 then
        Window = TOH:MakeWindow({Name = "Helix Hub | BAN LAND", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest"})
    end

    --Getgenv stuff

    getgenv().WantedInfiniteJumpingHeight = 50
    getgenv().XylesMutate = nil
    getgenv().RobuxMutate = nil
    getgenv().Gear = nil
    ...
    local Autofarms = Autofarm:AddSection({
        Name = "Autofarm"
    })
    local Movements = Character:AddSection({
        Name = "Movement"
    })
    local Jumps = Character:AddSection({
        Name = "Infinite Jump"
    })
    local Mutators = Shop:AddSection({
        Name = "Mutators"
    })
    local Gears = Shop:AddSection({
        Name = "Gears"
    })
    local Tools = Misc:AddSection({
        Name = "Tools"
    })
    local FreeMut = Misc:AddSection({
        Name = "Free Mutators"
    })
    local Credits = Credits:AddSection({
        Name = "Credits"
    })
    local AutofamrsOPT = Autofarm:AddSection({
        Name = "Section"
    })
    ...
    Tools:AddButton({
        Name = "Get Every In-Game Tools",
        Callback = function()
            for i,v in pairs(game:GetService("ReplicatedStorage").Gear:GetChildren()) do
                getgenv().Tool = v:Clone()
                getgenv().Tool.Parent = game:GetService("Players").LocalPlayer.Backpack
                TOH:MakeNotification({
                    Name = "Notification",
                    Content = "You Were Given A Tool",
                    Image = "rbxassetid://4483345998",
                    Time = 3.5
                })
            end
    ...
    Credits:AddButton({
        Name = "Creator",
        Callback = function()
            setclipboard("https://www.roblox.com/users/2662168667/profile")
            TOH:MakeNotification({
                Name = "Notification",
                Content = "Copied Creator Profile",
                Image = "rbxassetid://4483345998",
                Time = 3.5
            })
        end    
    ...
    Credits:AddButton({
        Name = "Discord",
        Callback = function()
            setclipboard("https://discord.gg/6JYdQaZxDH")
            TOH:MakeNotification({
                Name = "Notification",
                Content = "Copied Discord Sever",
                Image = "rbxassetid://4483345998",
                Time = 3.5
            })
        end    
    ...
    Credits:AddButton({
        Name = "UI Library",
        Callback = function()
            setclipboard("https://github.com/shlexware/Orion")
            TOH:MakeNotification({
                Name = "Notification",
                Content = "Copied UI Library Link",
                Image = "rbxassetid://4483345998",
    ...
    Credits:AddButton({
        Name = "Script Link",
        Callback = function()
            setclipboard("https://raw.githubusercontent.com/TryingShomen/Roblox/main/Helix.lua")
            TOH:MakeNotification({
                Name = "Notification",
                Content = "Copied Script Link",
                Image = "rbxassetid://4483345998",
                Time = 3.5
            })
        end    
    ...
    Mutators:AddButton({
        Name = "Buy Selected Mutator ( Xyles )",
        Callback = function()
            local A_1 = getgenv().XylesMutate
            local A_2 = "regular"
            local Event = game:GetService("ReplicatedStorage").buyMutator
            Event:InvokeServer(A_1, A_2)
        end    
    })
    Mutators:AddButton({
        Name = "Buy Selected Mutator ( Robux )",
        Callback = function()
            local A_1 = getgenv().RobuxMutate
            local A_2 = "product"
            local Event = game:GetService("ReplicatedStorage").buyMutator
            Event:InvokeServer(A_1, A_2)
        end    
    ...
    Gears:AddButton({
        ...
        Callback = function()
            local A_1 = getgenv().Gear
            local A_2 = "regular"
            local Event = game:GetService("ReplicatedStorage").buyItem
            Event:InvokeServer(A_1, A_2)
        end    
    })
    ...
    Autofarms:AddToggle({
        Name = "Bypass The Kill Script",
        Default = false,
        Callback = function(v)
            getgenv().Bypass = v

            while getgenv().Bypass do
                if not getgenv().Bypass then 
                    game:GetService("ReplicatedStorage"):WaitForChild("KillScript").Parent = game:GetService("Workspace"):WaitForChild(game:GetService("Players").LocalPlayer.Name)
                end
                wait(0)
                for i,v in pairs(game:GetService("Workspace"):WaitForChild(game:GetService("Players").LocalPlayer.Name):GetChildren()) do
    ...
    Jumps:AddToggle({
        ...
        Callback = function(v)
            ...
            if getgenv().InfJump then
                _G.JumpHeight = getgenv().WantedInfiniteJumpingHeight;
                if UserInput.UserInputType == Enum.UserInputType.Keyboard and UserInput.KeyCode == Enum.KeyCode.Space then
                    Action(Player.Character.Humanoid or Player.Character.fakehumanoid, function(self)
    ...
    AutofamrsOPT:AddToggle({
        ...
        Callback = function(value)
            ...
            while getgenv().AutoFarm1 do
                if not getgenv().AutoFarm1 then return end

                game:GetService("TweenService"):Create(game:GetService("Workspace"):WaitForChild(game:GetService("Players").LocalPlayer.Name):WaitForChild("HumanoidRootPart"),TweenInfo.new(7.5,Enum.EasingStyle.Linear),{CFrame = game:GetService("Workspace").tower.sections.finish.start.CFrame}):Play()
                wait(7.5)
                game:GetService("Workspace"):WaitForChild(game:GetService("Players").LocalPlayer.Name):WaitForChild("HumanoidRootPart").Velocity = Vector3.new(0,2.5,0)
                game:GetService("Workspace"):WaitForChild(game:GetService("Players").LocalPlayer.Name):WaitForChild("HumanoidRootPart").CFrame = game:GetService("Workspace").tower.sections.finish.exit.carpet.CFrame + Vector3.new(0,2,0)
                wait(2.5)
                game:GetService("Workspace"):WaitForChild(game:GetService("Players").LocalPlayer.Name):WaitForChild("Humanoid").WalkToPart = game:GetService("Workspace").tower.sections.finish.FinishGlow
                wait(15)
            end
        end    
    })
    ...
    Jumps:AddSlider({
        ...
        ValueName = "Studs",
        Callback = function(v)
            getgenv().WantedInfiniteJumpingHeight = v
        end    
    })
    Mutators:AddDropdown({
        Name = "Mutator Selection ( Xyles )",
        Default = nil,
        Options = {"speed", "invincibility","gravity","fog","negative","time","lengthen"},
        Callback = function(v)
            getgenv().XylesMutate = v
        end    
    })
    Mutators:AddDropdown({
        Name = "Mutator Selection ( Robux )",
        Default = nil,
        Options = {"invisibility","double jump","bunny","checkpoints","double coins"},
        Callback = function(v)
            getgenv().RobuxMutate = v
        end    
    })
    Gears:AddDropdown({
        Name = "Gear Selection",
        Default = nil,
        Options = {"speed", "gravity","fusion","trowel","hook","hourglass"},
        Callback = function(v)
            getgenv().Gear = v
        end    
    })
